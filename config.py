...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7353099372:AAHKDUqGrZWuGmGcVbDyxle-WcLAjoP9AWk") # ⚠️ Required
    ...
    LOG_CHANNEL = int(os.environ.get('LOG_CHANNEL', '-1002170801684')) # ⚠️ Required
